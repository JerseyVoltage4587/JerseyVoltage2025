...
public class SwerveDriveJoysticks extends Command {
  ...
  private final SwerveSubsystem m_Swerve;
    ...
    this.xLimiter = new SlewRateLimiter(RobotConstants.kSwerveMaxAcceleration);
    this.yLimiter = new SlewRateLimiter(RobotConstants.kSwerveMaxAcceleration);
    this.thetaLimiter = new SlewRateLimiter(RobotConstants.kSwerveMaxAngularAcceleration);
  ...
  public void execute() {
    ...
    theta = Math.abs(theta) > RobotConstants.kDeadBand ? theta : 0.0;
